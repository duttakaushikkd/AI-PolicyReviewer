...
const EMPTY_STORE = { claims: [], reviews: [] };
...
export function getClientStoreSnapshot() {
...
export function subscribeToStoreChange(onStoreChange) {
  if (typeof window === "undefined") return () => {};
...
export function subscribeToClientStore(callback) {
  return subscribeToStoreChange(() => callback(getClientStoreSnapshot()));
}
